...
const TeamMember: React.FC<TeamMemberProps> = ({ name, regNumber, phone, email, role }) => {
  return (
    <div className="bg-white border border-gray-200 p-6 rounded-lg shadow-md mb-6">
      <h2 className="text-2xl font-bold mb-2">{name}</h2>
      <p className="text-gray-700 mb-1"><strong>Registration Number:</strong> {regNumber}</p>
      <p className="text-gray-700 mb-1"><strong>Role:</strong> {role}</p>
